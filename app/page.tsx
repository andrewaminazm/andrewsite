        ...
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-center gap-4 px-6 py-3 text-sm">
          ...
          <details className="relative group">
            ...
            <div className="absolute left-1/2 top-full z-20 mt-1 w-56 -translate-x-1/2 rounded-lg border border-white/10 bg-[#1a2332] py-1 shadow-xl">
              ...
              <a href="https://marvelous-basbousa-32074f.netlify.app/" target="_blank" rel="noopener noreferrer" className="block px-4 py-2.5 text-sm text-[#e2e8f0] hover:bg-[#3b82f6]/20 hover:text-[#60a5fa]">
                API Test Blog
              </a>
              ...
              <a href="https://rainbow-puppy-8d0d6f.netlify.app/" target="_blank" rel="noopener noreferrer" className="block px-4 py-2.5 text-sm text-[#e2e8f0] hover:bg-[#3b82f6]/20 hover:text-[#60a5fa]">
                Testing Hub
              </a>
            </div>
          </details>
          <details className="relative group">
            ...
            <div className="absolute left-1/2 top-full z-20 mt-1 w-64 -translate-x-1/2 rounded-lg border border-white/10 bg-[#1a2332] py-1 shadow-xl">
              ...
              <a href="https://cozy-puppy-16fa93.netlify.app/" target="_blank" rel="noopener noreferrer" className="block px-4 py-2.5 text-sm text-[#e2e8f0] hover:bg-[#3b82f6]/20 hover:text-[#60a5fa]">
